...
cover: /images/covers/slow-intelligence.jpg
coverAlt: Dusk on still water, seen past the mast and bow of a small wooden boat.
tags:
  - Slow Intelligence
  - Agency
  - Design ethics
...
<ol class="art-list">
  <li><strong>Keep capability close to where it is used.</strong> Sovereignty is not abstract. When we
    built an AI assistant for Namibia, we ran it on a machine we operate ourselves — no US cloud in the
    pipeline — with the goal of moving it into the country, and we are building Oshiwambo in as
    infrastructure, not as an afterthought. Where intelligence lives, and in whose language it speaks, decides who stays capable.</li>
